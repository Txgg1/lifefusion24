/**
          --- SignUp2aShowScreen.jsx ---

  * Description:

    Ce fichier définit le composant d'écran `SignUp2aShowScreen`(avec avatar pour test), qui est une étape du processus d'inscription.
    Cet écran permet aux utilisateurs de renseigner des informations spécifiques dans le cadre de l'inscription.
    Ici on simule que la photo à est prise par la camera du telephone (Screen non utilisé dans le projet)
  ...
  * Fonctions:
    SignUp2aShowScreen: Fonction principale qui rend (génére) l'interface utilisateur de l'écran `SignUp2aShowScreen`.
